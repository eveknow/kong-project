...
public class TrackingRabbitMQConfig {
    ...
    private static TrackingRabbitMQConfig instanceRef;
    ...
    public TrackingRabbitMQConfig(@Value("${rabbitmq.exchange}") String exchange,
    ...
    private static void initConstructor(TrackingRabbitMQConfig t) {
        instanceRef = t;
    }

    public static TrackingRabbitMQConfig getInstanceRef() {
        return instanceRef;
    }
